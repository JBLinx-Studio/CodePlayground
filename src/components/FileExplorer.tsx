...
import { Folder, File, Plus, Trash2, ChevronDown, ChevronUp, Pencil, Check } from "lucide-react";
              ...
              >
                {cssFiles.map((fileName) => (
                  ...
                  >
                    {isRenaming && fileToRename === fileName ? (
                      <div className="flex-1 flex items-center">
                        <File size={14} className="mr-2 flex-shrink-0 text-[#3b82f6]" />
                        <input
                          ref={inputRef}
                          type="text"
                          value={newName}
              ...
              >
                {jsFiles.map((fileName) => (
                  ...
                  >
                    {isRenaming && fileToRename === fileName ? (
                      <div className="flex-1 flex items-center">
                        <File size={14} className="mr-2 flex-shrink-0 text-[#f59e0b]" />
                        <input
                          ref={inputRef}
                          type="text"
                          value={newName}
                ...
                >
                  {otherFiles.map((fileName) => (
                    ...
                    >
                      {isRenaming && fileToRename === fileName ? (
                        <div className="flex-1 flex items-center">
                          <File size={14} className="mr-2 flex-shrink-0 text-[#9ca3af]" />
                          <input
                            ref={inputRef}
                            type="text"
                            value={newName}
