...
import { Layout, Code, Monitor, Sparkles, Pin, BookOpen, Settings } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        variants={itemVariants}
      >
        <div className="flex items-center justify-between bg-gradient-to-r from-[#1a1f2c]/50 to-[#151922]/40 backdrop-blur-sm rounded-md px-3 py-2 border border-[#2d3748]/30 shadow-inner">
